...
type Folder struct {
	...
	Status            FolderNexusStatus `json:"status,omitempty" yaml:"status,omitempty"`
}

// +k8s:openapi-gen=true
type FolderNexusStatus struct {
	Nexus NexusStatus `json:"nexus,omitempty" yaml:"nexus,omitempty"`
}

func (c *Folder) CRDName() string {
	return "folders.folder.edge-orchestrator.intel.com"
}

func (c *Folder) DisplayName() string {
	if c.GetLabels() != nil {
