...
type ProjectActiveWatcher struct {
	...
	Spec              ProjectActiveWatcherSpec        `json:"spec,omitempty" yaml:"spec,omitempty"`
	Status            ProjectActiveWatcherNexusStatus `json:"status,omitempty" yaml:"status,omitempty"`
}

// +k8s:openapi-gen=true
type ProjectActiveWatcherNexusStatus struct {
	Nexus NexusStatus `json:"nexus,omitempty" yaml:"nexus,omitempty"`
}

func (c *ProjectActiveWatcher) CRDName() string {
	return "projectactivewatchers.projectactivewatcher.edge-orchestrator.intel.com"
}

func (c *ProjectActiveWatcher) DisplayName() string {
	if c.GetLabels() != nil {
...
// +k8s:openapi-gen=true
type ProjectActiveWatcherSpec struct {
...
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
type ProjectActiveWatcherList struct {
	metav1.TypeMeta `json:",inline" yaml:",inline"`
	metav1.ListMeta `json:"metadata" yaml:"metadata"`
	Items           []ProjectActiveWatcher `json:"items" yaml:"items"`
}
