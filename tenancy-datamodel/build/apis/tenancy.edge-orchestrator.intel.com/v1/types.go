...
type MultiTenancy struct {
	...
	Spec              MultiTenancySpec        `json:"spec,omitempty" yaml:"spec,omitempty"`
	Status            MultiTenancyNexusStatus `json:"status,omitempty" yaml:"status,omitempty"`
}

// +k8s:openapi-gen=true
type MultiTenancyNexusStatus struct {
	Nexus NexusStatus `json:"nexus,omitempty" yaml:"nexus,omitempty"`
}

func (c *MultiTenancy) CRDName() string {
	return "multitenancies.tenancy.edge-orchestrator.intel.com"
}

func (c *MultiTenancy) DisplayName() string {
	if c.GetLabels() != nil {
...
type MultiTenancyList struct {
	...
	Items           []MultiTenancy `json:"items" yaml:"items"`
}
