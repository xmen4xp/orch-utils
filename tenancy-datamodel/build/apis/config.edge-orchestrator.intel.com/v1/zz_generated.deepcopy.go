...
func (in *ConfigSpec) DeepCopyInto(out *ConfigSpec) {
	*out = *in
	if in.OrgsGvk != nil {
		in, out := &in.OrgsGvk, &out.OrgsGvk
		*out = make(map[string]Child, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.OrgWatchersGvk != nil {
		in, out := &in.OrgWatchersGvk, &out.OrgWatchersGvk
		*out = make(map[string]Child, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.APIMappingsGvk != nil {
		in, out := &in.APIMappingsGvk, &out.APIMappingsGvk
		*out = make(map[string]Child, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
	}
	if in.ProjectWatchersGvk != nil {
		in, out := &in.ProjectWatchersGvk, &out.ProjectWatchersGvk
		*out = make(map[string]Child, len(*in))
		for key, val := range *in {
			(*out)[key] = val
		}
