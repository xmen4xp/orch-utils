...
// DeepCopyInto is an autogenerated deepcopy function, copying the receiver, writing into out. in must be non-nil.
func (in *OrgNexusStatus) DeepCopyInto(out *OrgNexusStatus) {
	*out = *in
	out.OrgStatus = in.OrgStatus
	out.Nexus = in.Nexus
	return
}

// DeepCopy is an autogenerated deepcopy function, copying the receiver, creating a new OrgNexusStatus.
func (in *OrgNexusStatus) DeepCopy() *OrgNexusStatus {
	if in == nil {
		return nil
	}
	out := new(OrgNexusStatus)
	in.DeepCopyInto(out)
	return out
}
