...
type RuntimeOrg struct {
	...
	Spec              RuntimeOrgSpec        `json:"spec,omitempty" yaml:"spec,omitempty"`
	Status            RuntimeOrgNexusStatus `json:"status,omitempty" yaml:"status,omitempty"`
}

// +k8s:openapi-gen=true
type RuntimeOrgNexusStatus struct {
	Nexus NexusStatus `json:"nexus,omitempty" yaml:"nexus,omitempty"`
}

func (c *RuntimeOrg) CRDName() string {
	return "runtimeorgs.runtimeorg.edge-orchestrator.intel.com"
}

func (c *RuntimeOrg) DisplayName() string {
	if c.GetLabels() != nil {
...
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
type RuntimeOrgList struct {
	metav1.TypeMeta `json:",inline" yaml:",inline"`
	metav1.ListMeta `json:"metadata" yaml:"metadata"`
	Items           []RuntimeOrg `json:"items" yaml:"items"`
}
