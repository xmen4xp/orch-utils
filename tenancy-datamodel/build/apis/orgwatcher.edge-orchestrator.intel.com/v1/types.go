...
type OrgWatcher struct {
	...
	Status OrgWatcherNexusStatus `json:"status,omitempty" yaml:"status,omitempty"`
}

// +k8s:openapi-gen=true
type OrgWatcherNexusStatus struct {
	Nexus NexusStatus `json:"nexus,omitempty" yaml:"nexus,omitempty"`
}

func (c *OrgWatcher) CRDName() string {
	return "orgwatchers.orgwatcher.edge-orchestrator.intel.com"
}

func (c *OrgWatcher) DisplayName() string {
	if c.GetLabels() != nil {
...
// +k8s:deepcopy-gen:interfaces=k8s.io/apimachinery/pkg/runtime.Object
type OrgWatcherList struct {
	metav1.TypeMeta `json:",inline" yaml:",inline"`
	metav1.ListMeta `json:"metadata" yaml:"metadata"`
	Items           []OrgWatcher `json:"items" yaml:"items"`
}
