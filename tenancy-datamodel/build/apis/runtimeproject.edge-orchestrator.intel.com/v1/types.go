...
type RuntimeProject struct {
	...
	Spec              RuntimeProjectSpec        `json:"spec,omitempty" yaml:"spec,omitempty"`
	Status            RuntimeProjectNexusStatus `json:"status,omitempty" yaml:"status,omitempty"`
}

// +k8s:openapi-gen=true
type RuntimeProjectNexusStatus struct {
	Nexus NexusStatus `json:"nexus,omitempty" yaml:"nexus,omitempty"`
}

func (c *RuntimeProject) CRDName() string {
	return "runtimeprojects.runtimeproject.edge-orchestrator.intel.com"
}

func (c *RuntimeProject) DisplayName() string {
	if c.GetLabels() != nil {
...
// +k8s:openapi-gen=true
type RuntimeProjectSpec struct {
	Deleted           bool             `json:"deleted" yaml:"deleted"`
	ActiveWatchersGvk map[string]Child `json:"activeWatchersGvk,omitempty" yaml:"activeWatchersGvk,omitempty" nexus:"children"`
}
...
type RuntimeProjectList struct {
	...
	Items           []RuntimeProject `json:"items" yaml:"items"`
}
