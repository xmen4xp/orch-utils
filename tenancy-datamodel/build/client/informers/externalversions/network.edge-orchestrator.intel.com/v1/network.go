...
import (
	...
	v1 "github.com/open-edge-platform/orch-utils/tenancy-datamodel/build/client/listers/network.edge-orchestrator.intel.com/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.NetworkEdgeV1().Networks().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.NetworkEdgeV1().Networks().Watch(context.TODO(), options)
			},
		},
		&networkedgeorchestratorintelcomv1.Network{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *networkInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&networkedgeorchestratorintelcomv1.Network{}, f.defaultInformer)
}
