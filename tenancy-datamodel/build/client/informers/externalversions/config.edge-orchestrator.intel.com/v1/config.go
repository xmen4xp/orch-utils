...
import (
	...
	v1 "github.com/open-edge-platform/orch-utils/tenancy-datamodel/build/client/listers/config.edge-orchestrator.intel.com/v1"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.ConfigEdgeV1().Configs().List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.ConfigEdgeV1().Configs().Watch(context.TODO(), options)
			},
		},
		&configedgeorchestratorintelcomv1.Config{},
		resyncPeriod,
		indexers,
	)
}
...
func (f *configInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&configedgeorchestratorintelcomv1.Config{}, f.defaultInformer)
}
