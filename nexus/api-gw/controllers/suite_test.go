...
import (
	...
	adminnexusv1 "nexus/admin/api/build/apis/admin.admin.nexus.com/v1"
	...
	domain_nexus_org_v1 "nexus/admin/api/build/apis/domain.admin.nexus.com/v1"
	routenexusv1 "nexus/admin/api/build/apis/route.admin.nexus.com/v1"
